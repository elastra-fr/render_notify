...
The addon is currently in its early stages of development, and the version is set to 0.0.1. The author is Emmanuel LASTRA DE NATIAS. The addon is designed to work with Blender version 4.0.0 and above.
...
L'addon est actuellement en cours de développement, et la version est définie à 0.0.1. L'auteur est Emmanuel LASTRA DE NATIAS. L'addon est conçu pour fonctionner avec Blender version 4.0.0 et supérieure.
